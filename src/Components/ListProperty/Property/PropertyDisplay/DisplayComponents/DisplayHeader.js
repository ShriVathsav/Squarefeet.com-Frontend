...
const DisplayHeader = (props) => {
    ...
    const {unitSelectedProps, screenWidthProps} = useContext(Context)
    ...
    useEffect(() => {
        ...
        console.log(unitSelectedProps, screenWidthProps)
    }, [])
    ...
    return(
        ...
        <div style={{position: "fixed", top: 66, zIndex: 100, paddingTop: "27px",
                backgroundColor: "white"}} id="master-header">
            <Container>
            <Segment style={{margin: 0, borderRadius: 0,  width: "100%"}} id="segment-header-main">
                <Grid>
